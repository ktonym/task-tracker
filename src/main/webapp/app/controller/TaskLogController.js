Ext.define('TTT.controller.TaskLogController', {
    ...
    refs: [  {
        ...
        selector: 'managetasklogs tasklogfom #saveBtn'
    },{
        ...
        ref: 'startDateField',
        selector: 'managetasklogs tasklogform datefield[name=startDate]'
    },{
        ref: 'endDateField',
        selector: 'managetasklogs tasklogform datefield[name=endDate]'
    },{
        ref: 'taskCombo',
